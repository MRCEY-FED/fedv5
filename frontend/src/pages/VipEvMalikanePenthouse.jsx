...
import { ArrowLeft, Building2, X, ChevronLeft, ChevronRight, Star, DollarSign, Maximize, MapPin, Bed } from 'lucide-react';

const VipEvMalikanePenthouse = () => {
  ...
  const mulkler = [
    {
      id: 1,
      isim: "Eclipse Tower Penthouse",
      resim: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200",
      aciklama: "Şehrin en yüksek binasında penthouse. 360 derece manzara, özel asansör ve helipad.",
      fiyat: "5.000.000$",
      metrekare: "500 m²",
      oda: "4+1",
      konum: "Eclipse Tower",
    ...
    {
      id: 2,
      isim: "Luxury Sky Penthouse",
      resim: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=1200",
      aciklama: "Ultra lüks gökyüzü evi. Özel havuz, spa ve butler hizmeti.",
      fiyat: "7.500.000$",
      metrekare: "650 m²",
      oda: "5+2",
      konum: "Maze Bank Tower",
      yildiz: 5
    },
    {
      id: 3,
      isim: "Downtown Penthouse",
      resim: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200",
      aciklama: "Şehir merkezinde modern penthouse. Gece hayatına yakın, eğlence odaklı tasarım.",
      fiyat: "3.500.000$",
      metrekare: "350 m²",
      oda: "3+1",
      konum: "Downtown",
    ...
    {
      id: 4,
      isim: "Ocean View Penthouse",
      resim: "https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=1200",
      aciklama: "Okyanus manzaralı penthouse. Geniş teras, açık hava jakuzisi ve barbekü alanı.",
      fiyat: "4.200.000$",
      metrekare: "400 m²",
      oda: "3+1",
      konum: "Del Perro Heights",
      yildiz: 5
    },
    {
      id: 5,
      isim: "Art Deco Penthouse",
      resim: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=1200",
      aciklama: "Art deco tarzında tarihi bina penthouse'u. Vintage şıklık ve modern konfor.",
      fiyat: "3.000.000$",
      metrekare: "300 m²",
      oda: "2+1",
      konum: "Vinewood",
    ...
    <div className="min-h-screen bg-black">
          ...
          <div className="max-w-5xl w-full bg-gradient-to-br from-gray-900 to-black border border-amber-500/30 rounded-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 text-center">
                  <Maximize className="w-6 h-6 text-amber-400 mx-auto mb-2" />
      ...
      <section className="relative pt-24 pb-12 px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          <Link to="/vip-store/evmalikane" className="inline-flex items-center gap-2 px-4 py-2 mb-8 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 rounded-xl text-amber-400 font-medium transition-all duration-300">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto">
              Şehir manzaralı penthouse daireler - Fotoğraflara tıklayarak detayları görün
            </p>
          </div>
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 left-3 right-3">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-amber-400 font-semibold">{mulk.fiyat}</span>
                      <div className="flex items-center gap-1">
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center gap-4 text-sm">
                    <span className="text-amber-400">{mulk.metrekare}</span>
                    <span className="text-gray-500">•</span>
                    <span className="text-amber-400">{mulk.oda}</span>
                  </div>
                </div>
              </div>
            ))}
...
export default VipEvMalikanePenthouse;
